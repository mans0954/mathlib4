...
/- The topology of Uniform convergence generated by finite sets coincides with that generated by
singletons-/
lemma finite : UniformConvergenceCLM σ₁₂ F {{x} | (x : E)}
    = UniformConvergenceCLM σ₁₂ F {(s : Set E) | Finite s} := rfl
